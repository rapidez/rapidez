...
document.addEventListener('vue:loaded', function (event) {
    ...
    for (const path in components) {
        const isEager = components[path] !== null && typeof components[path] === "object" && !Array.isArray(components[path])
        ...
        vue.component(componentName, isEager ? components[path] : defineAsyncComponent(components[path]))
    }
});
